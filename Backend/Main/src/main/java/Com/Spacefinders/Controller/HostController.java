...
public class HostController {
    ...
    public ResponseEntity<ApiResponse<List<PropertyResponse>>> viewAllProperty(@PathVariable int userId) {
    ...
    public ResponseEntity<ApiResponse<PropertyDetailResponse>> viewPropertyById(@PathVariable int propertyId) {
    ...
    public ResponseEntity<ApiResponse<List<PropertyResponse>>> viewDeleteProperty(@PathVariable int userId) {
    ...
    public ResponseEntity<ApiResponse<List<BookingResponse>>> viewBookings(@PathVariable int userId) {
